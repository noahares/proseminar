...
\begin{frame}{\secname\ | \subsecname}
    \begin{itemize}[<+->]
        ...
        \item For IoT environments with their tight resource-constraints this requires further messurements, e.g. scaling key management solutions \cite{patil2014big}
            \note{
                many manufacturers of IoT devices send them out with default settings that are not changed by the buyers \\
                imagine WannaCry-like attack with IoT devices \\
                WannaCry hit the UKs NHS hospitals with 70.000 devices including computers, MRI scanners and blood-storage refrigerators \\
                PKI has to be automated to manage certificates on this scale
            }
...
\begin{frame}{\secname\ | \subsecname}
    \begin{itemize}[<+->]
        ...
        \note{
            most are in radiology and cardiology \\
            AI-based medical services will be patient driven and provided by big companies on the private market
        }
